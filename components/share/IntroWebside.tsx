  ...
  return (
    <>
      <section>
        ...
        <section className="h-33vh mx-auto lg:w-2/3 lg:bg-[url('/assets/images/space.png')] lg:bg-contain lg:bg-no-repeat">
          ...
          <section className="container mx-auto mt-16 grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 py-12 lg:grid-cols-1">
            ...
            <p className="my-4 -mt-12 text-base text-slate-700 md:my-6 md:text-lg">
              ...
              begleitet, beratet und unterstÃÂ¼tzt Sie professionell bei der
              Planung und Umsetzung Ihres individuellen Interieure Desings in
              Wohnung, Haus, BÃÂ¼ro ofer Praxis. Sprechen Sie uns an - Wir
              freuen uns auf Sie!
            </p>
          </section>

          <div className="bg-zenseGrey-500 mb-20 flex flex-col">
            <EmailModal />
          </div>
          ...
          <section className="container mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 lg:grid-cols-1">
            ...
            <p className="my-4 text-base text-slate-700 md:my-6 md:text-lg">
              <span className="font-bold text-zenseSignal2">8zenSe.com</span>{" "}
              steht fÃÂ¼r individuelles, extravagantes und exklusives Desing aus
