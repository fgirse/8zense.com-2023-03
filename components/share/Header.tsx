...
const Header = () => {
  return (
    <header className="h-20 flex flex-col lg:h-20 text-white items-center justify-between bg-slate-700">
   <div
        id=""
        className="bg-slate-00 w-[100-vw] h-20 flex flex-row items-center justify-between 
