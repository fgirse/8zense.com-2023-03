  ...
  return (
    <>
      <section className="bg-zenseGrey">
        <div className="relative mx-auto w-28 bg-zenseGrey md:w-24">
          <Image
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
              <div className="max-w-xl lg:max-w-lg">
                <h2 className="text-3xl font-bold tracking-tight text-zenseSignal2/50 sm:text-4xl">
                  8zense.com Newsletter anfordern.
                </h2>
                <p className="mt-4 text-lg leading-8 text-gray-300">
                  Erhalten Sie regelmässig unseren Newsletter in welchem wir
                  über neueste Trends im Design in loser Folge berichten¨{" "}
                </p>
              ...
              <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                <div className="flex flex-col items-start">
                  <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                    <CalendarDaysIcon
                      className="text-zenseGray h-6 w-6"
                      aria-hidden="true"
                    />
                  </div>
