      ...
      <div className="space-y-12">
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div className="sm:col-span-3">
            <label className="block text-start text-sm font-medium leading-6 text-gray-900">
              First name
            </label>
            <div className="mt-2">
              <input
            ...
            <div className="relative flex gap-x-3">
              ...
              <div className="text-sm leading-6">
                <span className="text-start text-gray-900">
                  {" "}
                  I agree to the <span className="font-medium">
                    terms
                  </span> and <span className="font-medium">conditions</span>
                </span>
              </div>
            </div>
          </fieldset>
